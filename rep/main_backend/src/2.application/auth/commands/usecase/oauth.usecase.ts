...
import { NotAllowOauthLoginError, NotInvalidOauthUserError, NotValidEmailError } from "@error/application/user/user.error";
...
export class OauthUsecase<T, CT> {
  ...
  private readonly selectUserAndOauthWhereEmailFromDb: OauthUsecaseProps<T, CT>["selectUserAndOauthWhereEmailFromDb"];
  private readonly userIdGenerator : OauthUsecaseProps<T, CT>["userIdGenerator"];
  private readonly insertUserAndOauthDataToDb : OauthUsecaseProps<T, CT>["insertUserAndOauthDataToDb"];
  private readonly tokenIssuersInterfaceMakeIssuer : OauthUsecaseProps<T, CT>["tokenIssuersInterfaceMakeIssuer"];
  ...
  constructor({
    usecaseValues, selectUserAndOauthWhereEmailFromDb, userIdGenerator, insertUserAndOauthDataToDb, tokenIssuersInterfaceMakeIssuer, makeHash, insertRefreshDataToCache
