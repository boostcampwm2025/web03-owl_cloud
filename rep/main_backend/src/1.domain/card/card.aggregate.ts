...
type CreateCardInput = Omit<CardProps,
"card_id" | "created_at" | "updated_at" | "deleted_at" 
>;

type CreateCardItemInput = Omit<CardItemProps, 
"card_id" | "item_id" | "created_at" | "updated_at" | "deleted_at" 
>;

type CreateCardItemAssetInput = Omit<CardItemAssetProps, 
...
export class CardAggregate {
  ...
  public getCardData() : Required<Omit<CardProps, "deleted_at">> | Record<"deleted_at", CardProps["deleted_at"]>  {
    return this.card.getData();
  };
  public getCardItems() : readonly CardItem[] { return this.cardItems; };
  public getCardItemAssets() : readonly CardItemAsset[] { return this.cardItemAssets; };
  public getCardState() : CardState | undefined { return this.card_stat; };
