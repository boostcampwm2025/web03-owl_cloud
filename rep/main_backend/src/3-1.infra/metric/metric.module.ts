...
@Module({
  ...
  providers: [ConfigService, PrometheusService, HttpMetricsInterceptor, WsMetricsInterceptor],
  exports: [PrometheusService, HttpMetricsInterceptor, WsMetricsInterceptor],
})
