...
- 서비스 클로비(Clobby)는 "나만 알기 아까운 취미와 취향"을 한 장의 카드로 기록하고, 타로 카드를 뽑듯 타인의 취미와 취향을 우연히 발견하는 초경량 취향 기반 카드 플랫폼입니다.
